...
(function (factory) {
	...
	*/
	...
	if (!engine.IsAttached) {
		...
		var createNativeTrigger = function (type) {
			var prefix = 'coherent-js:' + type + ':';
			return function () {
				var json = JSON.stringify(Array.prototype.slice.call(arguments, 2));
		...
		// omg crap crap
		engine.SendMessage = createNativeTrigger('c');
		engine.TriggerEvent = createNativeTrigger('e');
