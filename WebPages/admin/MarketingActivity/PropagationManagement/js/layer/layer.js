	...
	s.anim = ["layer-anim", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], l.pt.config = {
		...
		return t.move && s.css("cursor", "move"), s.on("mousedown", function(e) {
			...
			if (c.moveStart) {
				...
				if (i.preventDefault(), c.stX = t.fixed ? 0 : n.scrollLeft(), c.stY = t.fixed ? 0 : n.scrollTop(), !t.moveOut) {
					var s = n.width() - l.outerWidth() + c.stX,
						f = n.height() - l.outerHeight() + c.stY;
		...
		var n = i("#" + s[0] + e),
			...
			r = n.attr("type"),
			l = n.find(s[1]).outerHeight() || 0,
			f = n.find("." + s[6]).outerHeight() || 0;
		r !== o.type[3] && r !== o.type[4] && (parseFloat(t.width) <= 260 && (t.width = 260), parseFloat(t.height) - l - f <= 64 && (t.height = 64 + l + f), n.css(t), r === o.type[2] ? n.find("iframe").css({
		...
		var a = i("#" + s[0] + e),
			...
			f = a.attr("minLeft") || 261 * o.minIndex + "px";
		o.record(a), o.minLeft[0] && (f = o.minLeft[0], o.minLeft.shift()), a.attr("position", a.css("position")), r.style(e, {
			width: 180,
			height: l,
			left: f,
			top: n.height() - l,
			position: "fixed",
			overflow: "hidden"
		}), a.find(".layui-layer-min").hide(), "page" === a.attr("type") && a.find(s[4]).hide(), o.rescollbar(e), a.attr("minLeft") || o.minIndex++, a.attr("minLeft", f)
