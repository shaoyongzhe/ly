...
var activityManger_addSub1Data=resdata.activity_condition.activity_itemkind;
...
//  +                           '<p class="bor hi -hi selectWrap1">降价幅度</p>'
    ...
    +                               '<input class="bor diInput mangeStyle" type="text" value="" disableds="disabled"/><span class="diSpan por mangeStyle" ></span>'
    +                           '</div>'                                
    +                       '</div>'
    +                   '</div>'
    +                   '<!--投放门店数-->'
    +                   '<div class="dib acPu mds">'                            
    +                       '<input class="bor acPuI1 mangeStyle" type="text" value="" disableds="disabled"/><span class="to"></span><input class="bor acPuI2 mangeStyle" type="text"  value="" disableds="disabled"/><span class="tip">不输入代表不限</span>'
    +                   '</div>'
    +                   '<!--添加删除按钮-->'
    +                   '<div class="acAd dib">'
...
//$(".addSub2Mange").remove();
if(resdata.distributor_condition){
    var activityManger_addSub2Data_distributor=resdata.distributor_condition;
    activityManger_addSub2HtmlFn(activityManger_addSub2Data_distributor,"分销商","家");
    console.log('分销商')
}
if(resdata.retailer_condtion){
    var activityManger_addSub2Data_retailer=resdata.retailer_condtion;  
    activityManger_addSub2HtmlFn(activityManger_addSub2Data_retailer,"门店","家");
    console.log('门店')
}
if(resdata.consumer_condition){
    var activityManger_addSub2Data_consumer=resdata.consumer_condition;
...
function activityManger_addSub2HtmlFn(obj, participants,unit){// participants为参与者，其值为分销商，门店，消费者等    
    ...
    activityManger_addSub2Html=''
        ...
        +                       '</div>'    
        +                   '</div>'
        +                   '<div class="dib red" style="visibility:hidden;">*主办方</div>'
        +                   '<!--参加名额acMe-->'
        +                   '<div class="dib acMe" style="margin-left:8px">'
        +                       '<div class="selectWrap1 -hi">'
        +                           '<span>'
        +                               '<input class="bor acMeI1 mangeStyle" type="text" value="" disableds/><span class="acMeS1">家</span>'
        +                           '</span><span class="to"></span><span>'
        +                               '<input class="bor acMeI2 mangeStyle" type="text"  value=""  disableds/>'
        ...
        +                               '<!--最后一个p标签内容随时变-->'
        +                               '<input type="text" class="min dayudengyu mangeStyle" disabled/><p class="dib">次</p>'
        +                           '</div>'    
        +                           '<!--介于对应的-->'
        +                           '<div class="-hi hi acZige5c acZige1Tab acZige4tab mangeStyle">'
        +                               '<!--最后一个p标签内容随时变-->'
        +                               '<input type="text" class="min jieyu1 mangeStyle" value="" disabled/><p>-</p><input type="text" class="jieyu2 mangeStyle" value="" disabled/><p class="dib"></p>'
        +                           '</div>'                                                            
        +                       '</div>'
        +                       '<!--添加删除按钮-->'
        +                       '<div class="acAdC dib">'
...
//  debugger
    ...
    $('.addSub2Mange:last').find(".acMeI1").val(obj.number_range.min);
    ...
    var activityManger_addSub3Html=''
        ...
        function activityManger_addSub3HtmlFn(a){
            ...
            if(obj[key].statisticrange!="至今"){
                ...
                console.log(resdata.activity.begintime,obj[key].begintime)
//              debugger
                var bgt1_ = new Date(resdata.activity.begintime) * 1;
...
/*增减控件4-活动补贴*/
//$(".addSub4Mange").remove();
var activityManger_addSub4Data=resdata.event_handler_list;
...
//      +           '</div>'
        ...
        +                   '<input type="text" class="mangeStyle" disabled/>'
        +               '</div>'
        +           '</div>'
        +           '<!--补贴峰值-->'
        ...
        +                   '<input type="text" class="sbys " disabled/>'
...
//      debugger
    ...
    if(activityManger_addSub4Data[i].prize_content){
        var addSub4MangeLimit=JSON.stringify(activityManger_addSub4Data[i].prize_content, null, 4);
        $(".addSub4Mange:last").find(".hdc7 .gl").val(addSub4MangeLimit);   
    }
    $(".addSub4Mange:last").find(".hdc7 .gl").addClass("glHidden"+(i+1));

    /*设置规则*/
    if(activityManger_addSub4Data[i].limit){
        var addSub4MangeProbability=JSON.stringify(activityManger_addSub4Data[i].limit, null, 4);
        $(".addSub4Mange:last").find(".hdc8 .gz").val(addSub4MangeProbability);
    }
...
//var activityManger_addSub5Data=resdata.等待字段;
...
if(location.href.indexOf("activityModify.html")>0){         
    ...
    //控件3
    //时刻记住，我是在控件2里的
    $(".addSub2Mange").find(".addSub3.created_l").remove();
