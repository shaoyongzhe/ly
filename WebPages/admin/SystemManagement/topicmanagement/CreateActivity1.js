...
_ajax("get", fzrurl, {}, '获取活动负责人', function (fzr){
...
// 设置概率
$('body').on('click','.setgailv.on',function(){
...
$('.butieSec').on('keyup','.acSe13 input',function(){
	...
	$('.sec.rule .hdsbys_text').text(ysCount);
...
$('.saveToDb, .shenhe').click(function(){
	...
	content.each(function(){
		...
		tuwenObj = {
	        ...
	        "posterurl": _this.find('.posterurl').attr('src'),
	...
	// _ajax("post", saveurl, data, '保存', function (data){
