								...
								'<article class="hidden_page_b">'+
									...
									'<footer>'+
										...
										'<section class="qualification">'+
											...
											'</div>'+
											'<div class="lification">'+
											'</div>'+
											'<div style="margin-top: 0.25rem;" class="xsp_z">'+
												'<a href="javascript:;">'+'消费者'+'</a>'+
											'</div>'+
											'<div class="consum">'+
											'</div>'+
											// '<div class="xsp_x">'+
					...
					function composeSubsidyObject(subsidyparameter)
					{
						...
						for (var i = 0; i <= subsidyparameter.length - 1; i++) 
						{
							li += '<a style="line-height: 1.1rem;font-size: 0.4rem;display: block;background: #fff2f2;">' + subsidyparameter[i].subsidyevent + '</a>'
								+ '<a style="line-height: 1.1rem;font-size: 0.4rem;display: block;background: #ffe5e5;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">' + subsidyparameter[i].subsidymethod + '</a>'
