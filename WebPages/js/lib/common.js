                ...
                if(data["error"]==""){
                    ...
                    for(var j=0;j<data["content"].length;j++){
                        ...
                        if(data["content"][j]["details"].length>1){
                            ...
                            if(data["content"][j]["openflag"]=="0"){
                                ...
                                if(heji < 0){
                                    ...
                                    _heji="应付：";
                                    var showheji=data["content"][j]["iswechatdiscount"] == true?heji-wechat:heji;
                                    _hisprice=showheji>0? showheji.toFixed(2):"0.00"
                            ...
                            if(data["content"][j]["openflag"]=="0"){
                                ...
                                _historyList+="<dd style="+"\"padding-top:10px;\""+" idd="+_pgg+" index="+j+"><div style=\"display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;width:100%\"><div class="+"\"imagebox\""+"><a href="+"\"#\""+"><img src="+data["content"][j]["details"][0]["itemobj"]["itemimage"]+" ></a></div><div class="+"\"dectitlebox\""
                        +" style=\"position:relative\"><div class="+"\"iconbox\""+">"+_icn+"</div><a style="+"\"float:left;\""+" href="+"\"#\""+">"+data["content"][j]["details"][0]["itemobj"]["itemname"]+"</a><i style=\"position:absolute;bottom:0;right:0\">共"+_ggf+"件</i></div></div><div class="+"\"descbox\""+"><p>订单号："+data["content"][j]["serialnumber"]+"</p><i class="+"\"il\""+">送货时间："+data["content"][j]["billexpecteddelivertime"].split(" ")[0].replace(/\-/g,"/")+"</i><i class="+"\"ir\""+">"+_heji+"<span class="+"\"pricstyle\""+">￥"+_hisprice+"</span></i></div></dd>"
                                ...
                                _shopList+="<dd style="+"\"padding-top:10px;\""+" idd="+_pgg+" index="+j+"><div style=\"display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;width:100%\"><div class="+"\"imagebox\""+"><a href="+"\"#\""+"><img src="+data["content"][j]["details"][0]["itemobj"]["itemimage"]+" ></a></div><div class="+"\"dectitlebox\""
                            ...
                            $.ajax({
                                ...
                                success: function (data2) {
                                    ...
                                    if (data2["error"] == "") {
                                            ...
                                            if (data2["content"][r]["details"].length > 1) {
                                                ...
                                                if (data2["content"][r]["iswechatdiscount"] == true) {
                                                    if (data2["content"][r]["openflag"] == 1) {
                                                        ...
                                                        if (data2["content"][r]["openflag"] == "0") {
                                                            ...
                                                            if (heji < 0) {
                                                                ...
                                                                _heji = "应付：";
                                                                var showheji = data["content"][r]["iswechatdiscount"] == true ? heji - wechat : heji;
                                                                _hisprice = showheji > 0 ? showheji.toFixed(2) : "0.00"
                                                            } else {
                                                                _heji = "合计：";
                                                                _hisprice = "0.00";
                                                    ...
                                                    if (data2["content"][r]["openflag"] == "0") {
                                                        ...
                                                        _historyList += "<dd style=" + "\"padding-top:20px;\"" + " idd=" + _pgg + " index=" + r + "><div style=\"display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;width:100%\"><div class=" + "\"imagebox\"" + "><a href=" + "\"#\"" + "><img src=" + data2["content"][r]["details"][0]["itemobj"]["itemimage"] + " ></a></div><div class=" + "\"dectitlebox\""
                                                + "><div class=" + "\"iconbox\"" + ">" + _icn + "</div><a style=" + "\"float:left;\"" + " href=" + "\"#\"" + ">" + data2["content"][r]["details"][0]["itemobj"]["itemname"] + "</a><i>共" + _fgg + "件</i></div></div><div class=" + "\"descbox\"" + "><p>订单号：" + data2["content"][r]["serialnumber"] + "</p><i class=" + "\"il\"" + ">送货时间：" + data2["content"][r]["billexpecteddelivertime"].split(" ")[0] + "</i><i class=" + "\"ir\"" + ">" + _heji + "<span class=" + "\"pricstyle\"" + ">￥" + _hisprice + "</span></i></div></dd>"
                                                        ...
                                                        _shopList += "<dd style=" + "\"padding-top:20px;\"" + " idd=" + _pgg + " index=" + r + "><div style=\"display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;width:100%\"><div class=" + "\"imagebox\"" + "><a href=" + "\"#\"" + "><img src=" + data2["content"][r]["details"][0]["itemobj"]["itemimage"] + " ></a></div><div class=" + "\"dectitlebox\""
                                        ...
                                        $("#container").attr("page", JSON.stringify(data2["paging"]));
